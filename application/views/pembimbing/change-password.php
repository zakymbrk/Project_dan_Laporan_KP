...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo base_url('pembimbing/view/profile') ?>">Profile</a></li>
    ...
    <div class="col-md-6">
        <div class="card fade-in">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo site_url('pembimbing/change_password'); ?>" method="post">
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo base_url('pembimbing/view/profile') ?>" class="btn btn-secondary">
