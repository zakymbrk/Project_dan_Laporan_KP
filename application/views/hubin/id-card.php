...
<head>
    ...
    <style>
        ...
        .qr-code{width:100px;height:100px;background-color:white;margin:20px auto;display:flex;align-items:center;justify-content:center;border-radius:10px}
